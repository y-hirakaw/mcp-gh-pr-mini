...
export class CliClient implements GitHubAuthClient {
  readonly method = AuthMethod.CLI;
   ...
   * GitHub CLI コマンドを実行
   */
  async executeCommand(args: string[]): Promise<{ success: boolean; stdout: string; stderr: string }> {
